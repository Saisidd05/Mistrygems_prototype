...
import { Play, ShieldCheck, CheckCircle2, FileText, Package, Tag, CircleDot, Truck, type LucideIcon } from 'lucide-react'
...
export function StatusBadge({ status, className }: StatusBadgeProps) {
  const config: Record<JobStatus, { label: string; badgeClass: string; icon: LucideIcon }> = {
