        ...
        <GlassCard className="p-6 lg:col-span-3">
          ...
          {activeSection === 'users' && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400">5 Admin & Manager accounts active</p>
            </div>
          )}
          ...
          {activeSection === 'roles' && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400">Manage permissions for Goldsmiths, QC Staff & Admins</p>
            </div>
          )}
